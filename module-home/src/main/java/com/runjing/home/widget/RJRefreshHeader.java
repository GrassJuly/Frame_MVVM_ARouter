package com.runjing.home.widget;
...
/**
 * @Created: qianxs  on 2020.07.19 01:33.
 * @Describe：
 * @Review：
 * @Modify：
 * @Version: v_1.0 on 2020.07.19 01:33.
 * @Remark:
 */
public class RJRefreshHeader extends InternalAbstract implements RefreshHeader {
...
//    protected Map<ValueAnimator, ValueAnimator.AnimatorUpdateListener> mUpdateListeners = new HashMap<>();
    ...
    public RJRefreshHeader(@NonNull Context context) {
        this(context, null);
    }

    public RJRefreshHeader(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RJRefreshHeader(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
...
//    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        float radius = (Math.min(width, height) - mCircleSpacing * 2) / 16;
...
//    }
    ...
    public RJRefreshHeader setSpinnerStyle(SpinnerStyle mSpinnerStyle) {
        this.mSpinnerStyle = mSpinnerStyle;
        return this;
    }

    public RJRefreshHeader setNormalColor(@ColorInt int color) {
        mNormalColor = color;
    ...
    public RJRefreshHeader setAnimatingColor(@ColorInt int color) {
