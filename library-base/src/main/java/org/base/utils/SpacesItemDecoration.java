...
/**
 * @Created: qianxs  on 2020.07.17 14:41.
 * @Describe：
 * @Review：
 * @Modify：
 * @Version: v_1.0 on 2020.07.17 14:41.
 * @Remark:
 */
public class SpacesItemDecoration extends RecyclerView.ItemDecoration {
     ...
     * @param layoutManager
     */
    public SpacesItemDecoration(int leftRight, int topBottom, int headItemCount, @LayoutManager int layoutManager) {
     ...
     * @param layoutManager
     */
    public SpacesItemDecoration(int space,boolean includeEdge, @LayoutManager int layoutManager) {
     ...
     * @param layoutManager
     */
    public SpacesItemDecoration(int space,int headItemCount,boolean includeEdge, @LayoutManager int layoutManager) {
        this.space = space;
        this.headItemCount = headItemCount;
     ...
     * @param layoutManager
     */
    public SpacesItemDecoration(int space,int headItemCount, @LayoutManager int layoutManager) {
     ...
     * @param layoutManager
     */
    public SpacesItemDecoration(int space, @LayoutManager int layoutManager) {
